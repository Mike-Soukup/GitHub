...
library(ggplot2)
machine <- read.csv(file.path("/Users/mikeysoukup/Desktop/NU MSDS/MSDS 401/Module 8/operator.csv"), sep=",")
str(machine)
...
wear <- read.csv("/Users/mikeysoukup/Desktop/NU MSDS/MSDS 401/Module 8/supplier_rcbd.csv", sep=",")
str(wear)
...
data <- read.csv("/Users/mikeysoukup/Desktop/NU MSDS/MSDS 401/Module 8/pipe.csv", sep=",")
str(data)
