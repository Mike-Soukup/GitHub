...
hospital <- read.csv(file.path("/Users/mikeysoukup/Desktop/NU MSDS/MSDS 401/Module 3/Hospital.csv"),sep=",")
str(hospital)
...
(mcr[2,8]-mcr[2,2]-mcr[2,3])/mcr[2,8] ###???? Why not over mcr[5,8]???
...
dbinom(5,10,p)  #dbinom(x,n,p)

# The binomial probability reflects sampling with replacement.

dhyper(5,32,168,10) #dhyper(x,A,N-A (gives you N), n)
