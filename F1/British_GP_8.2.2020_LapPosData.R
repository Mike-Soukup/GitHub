library(ggplot2)
df <- read.csv("/Users/mikeysoukup/Desktop/Python/F1/F1 Race British Grand Prix 8.2.2020.csv")
...
ggplot(data = df.race, aes(x = X)) +
  ...
  geom_line(aes(y = NH.RP, color = "RP1")) +
  geom_point(aes(y = NH.RP, fill = "RP1", color = "RP1"), shape = 21) +
  ...
  labs(title = "2020 F1 British Grand Prix", x = "Lap", y = "Position") +
